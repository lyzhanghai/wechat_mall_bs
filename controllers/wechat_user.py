...
class WeChatUserAmount(http.Controller):
        ...
        try:
            ...
            response = request.make_response(
                ...
                data=json.dumps({
                    ...
                    'msg': 'success',
                    'data': {
                        'balance': wechat_user.balance,
                        'freeze': wechat_user.freeze,
                        'score': wechat_user.score,
                    },
                })
            )
...
class WeChatUserDetail(http.Controller):
